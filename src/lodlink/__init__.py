...
et non-paramétriques, avec visualisations interactives.
...
Modules:
    ...
    visualizations: Visualisations de pedigrees et graphiques
...
from .visualizations import PedigreeViz, plot_genome_wide_lod, generate_results_table
